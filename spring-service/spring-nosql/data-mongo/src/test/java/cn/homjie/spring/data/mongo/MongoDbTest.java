...
import cn.homjie.spring.data.mongo.dao.OrderRepository;
import cn.homjie.spring.data.mongo.domain.Item;
...
public class MongoDbTest {
	...
	@Test
	public void testFindOrdersByType() {
		Order order = createAnOrder();
		...
		List<Order> foundOrder = orderRepository.findOrdersByType("NET");
		assertEquals(1, foundOrder.size());
		assertEquals("Chuck Wagon", foundOrder.get(0).getCustomer());
	}
